...
let Massage1=name=>`Hello, ${name}!`;


// TODO: Uncomment the following line of code to see the output in the browser console
console.log(message('Allie'));
console.log(Massage1('Allie'));
...
let joe1 = student1('Joe Schmoe', 100, 'Anytown, USA');
...
joe1.greeting1=()=>`Hi, my name is ${joe1.name}`;


// TODO: Uncomment the following line of code to see the output in the browser console
// Note that the arrow function will cause this method to break!
console.log(joe.greeting());
console.log(joe1.greeting1());
...
let courseName1=()=>'This student is enrolled in Code 301.';
...
//the object in the constructer
// 2. What is "this" when joe.scopeArrow() is invoked?
//is invoke the object 
// 3. Explain why "this" is different when an arrow function is used.
//becuse wa cant use this as methods